    ...
    public static class AppPreferenceFragment extends LeanbackPreferenceFragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            try {
                ...
                Log.e(TAG, "Error creating preference view", e);
                // Don't use hardcoded fallback - let the error propagate to show proper error handling
                throw new RuntimeException("Failed to create preference view", e);
            }
        }

        // Removed hardcoded video quality fallback - it was causing wrong dialogs to appear
        // Also removed unused setVideoQuality() and createFormatItemFromQuality() methods
